    ...
    return (
      <div className='Home'>
        ...
        <div className='home-body'>
          <h2 ref={this.ref1} className={`${this.state.animate ? 'reveal-text1' : ''}`}>General Benefits of Massage</h2>
          <div className='center'>
            ...
            <ul>
              <li>Cleanses impurities from immune system</li>
              <li>Revitalizes energy production</li>
              <li>Stress Management</li>
              <li>Improves lymph fuild circulation</li>
              <li>Improves post-op recovery</li>
              <li>Clear waste and swelling</li>
            </ul>
          <Reservation />
          <Footer />
        </div>
